...
/*******
 * <p> Title: NameValidationTestingAutomation Class. </p>
 * 
 ...
 * 
 */
public class NameValidationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(1, "Freddy", true);
		
		performTestCase(2, "F", true);
						
		performTestCase(3, "F'r-eddy", true);
				
		performTestCase(4, "Fred dy", true);
		
		performTestCase(5, "Fu'Reddy-John IV", true);
		
		performTestCase(6, "FreddyAlexanderBartholomewJavierJacobGeorgeTheFirst", false);
		
		performTestCase(7, "Freddy'", false);
		
		performTestCase(8, "Freddy-", false);
						
		performTestCase(9, " Freddy", false);
	...
	private static void performTestCase(int testCase, String inputText, boolean expectedPass) {
		...
		String resultText= nameValidation.NameValidation.checkForValidName(inputText);
