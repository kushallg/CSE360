...
/**
 * ModerationVisibilityTest — automated JUnit tests for Moderation & Visibility Controls.
 *
 * <p>TP3 Requirements covered (moderation & visibility):</p>
 * <ul>
 *   <li>R-MOD-01: Staff can hide posts and replies; students cannot.</li>
 *   <li>R-MOD-02: Hidden posts/replies stay hidden from students but visible to staff/admin.</li>
 ...
 *   <li>R-MOD-06: Moderation actions are logged whenever a valid hide/unhide/flag occurs.</li>
 *   <li>R-MOD-07: Students never see hidden content; staff/admin see “Hidden by Staff”.</li>
 ...
 *       role checks, visibility rules, and “reason” validation are expressed as boolean conditions.
 *   	 A green test indicates that the moderation rules and validation logic (as implemented)
 *       satisfy the stated moderation requirements. A red test indicates a violation of stated 
 *       Moderation & Visibility requirements.</li>
 * </ul>
 *
 * <p>Manual test coverage (UI / integration tests):</p>
 * <ul>
 *   <li>MT-MOD-01: Staff hides/unhides posts and replies and verifies student vs staff views.</li>
 *   <li>MT-MOD-02: Staff flags posts and confirms log entries and private visibility of flags.</li>
 *   <li>MT-MOD-03: Students attempting to view hidden content see “Content Not Available”.</li>
 *   <li>MT-MOD-04: Hidden content remains hidden after refresh / navigation.</li>
 * </ul>
 *
 * <p>Manual evidence location:</p>
 * <ul>
 *   <li>See Moderation & Visibility manual tests and screenshots in TP3 documents.</li>
 * </ul>
 */
public class ModerationVisibilityTest {
     ...
     *  Simulates a staff member attempting to hide a visible post with a valid reason.
     *  Verifies:
     ...
     *  - FAIL: any of these conditions is false, indicating missing validation or role checks.
     */
    @Test
     ...
     *  Verifies they are not considered staff and that the action & log are rejected.
     *
     * <p>Interpreting results:</p>
     ...
     *  - R-MOD-07 (Staff see “Hidden by Staff”, students see “Content Not Available”)
     *
     * <p>What this checks:</p>
     ...
     *
     * <p>Interpreting results:</p>
     *  - PASS: staffView contains label and full content. studentView is the placeholder message.
     ...
     *    - Both staff/admin and students see real content (no hidden label or placeholder).
     *
     * <p>Interpreting results:</p>
     ...
     *
     * <p>Requirements tested:</p>
     *  - R-MOD-06 (A log entry is created every time a post is hidden, unhidden, or flagged)
     *
     * <p>What this checks:</p>
