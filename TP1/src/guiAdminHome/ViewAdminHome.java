...
public class ViewAdminHome {
	...
	// *** CHANGE ***: Replaced the ComboBox with a ListView to allow for
	// multi-selection using standard controls.
	...
	protected static Button button_AdminRequests = new Button("Ticketing / Requests"); // NEW BUTTON
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		// It now correctly sets the user's name on the label because the 'theUser'
		// object
	...
	private ViewAdminHome() {
		...
		// It's populated with the available roles and configured to allow multiple
		// items to be
		...
		setupButtonUI(button_AdminRequests, "Dialog", 16, 250, Pos.CENTER, 300, 470);
