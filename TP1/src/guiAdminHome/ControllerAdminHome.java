...
public class ControllerAdminHome {
    ...
    /**
     * Handles the "Send Invitation" button action. It validates the email, checks for selected roles,
     * generates an invitation code via the database, and displays a confirmation message.
     */
    ...
    /**
     * Placeholder for the "Manage Invitations" action. Currently displays a "Not Yet Implemented" alert.
     */
    ...
    /**
     * Handles the "Set One-Time Password" button action. It prompts for a username,
     * validates it, generates an OTP, and displays a confirmation with the OTP.
     */
    ...
    /**
     * Handles the "Delete User" button action. It displays a dialog to select a user,
     * prevents self-deletion, asks for confirmation, and then deletes the user from the database.
     */
    ...
    /**
     * Handles the "List Users" button action. It launches the ViewListUsers window.
     */
    ...
    /**
     * Handles the "Add/Remove Roles" button action. It launches the ViewAddRemoveRoles window.
     */
    ...
    /**
     * A helper method to check if an email address is empty and show an alert if it is.
     * @param emailAddress The email address string to check.
    ...
    /**
     * Handles the "Logout" button action. It returns the user to the login screen.
     */
    ...
    /**
     * Handles the "Quit" button action. It terminates the application.
     */
