 ...
 *
 * @version 1.01		2025-10-18 Added Discussions button by Kushal Gadamsetty
 *
 */
...
public class ViewStudentHome {
	...
	// GUI Area 2: This area will now contain the entry point to the discussion forum.
	...
	private ViewStudentHome() {
        ...
        button_GoToDiscussions.setOnAction((event) -> { ControllerStudentHome.goToDiscussions(); });
		...
		// Place all of the widget items into the Root Pane's list of children
         theRootPane.getChildren().addAll(
			...
			button_GoToDiscussions, // Added button
